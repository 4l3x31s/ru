...
angular.module('ControladorVehiculos', [])
  //Buscar Deuda Vehículos
  .controller('BusDeudaCtrl', function ($scope, $ionicActionSheet, $timeout, $rootScope,
                                        ServiciosRuat, ServicioDatos, $location, $ionicHistory, $ionicPopup, $state) {
    ...
    $scope.consultaDeuda = function (numPlaca: string) {
      if (numPlaca != null) {
  ...
  .controller('DetalleDeudaCtrl', function ($scope, $ionicActionSheet, $timeout, $rootScope,
  ...
  //Buscar Datos Tecnicos Vehiculos
  .controller('DetVehCtrl', function ($scope, $ionicActionSheet, $timeout, $rootScope,
    ...
    $scope.consultaDetallada = function (placa: string, crpva: string) {
      if (placa != null) {
  ...
  .controller('VeDatosDetCtrl', function ($scope, $ionicActionSheet, $timeout, $rootScope,
                                          ServiciosRuat, ServicioDatos, $location, $ionicLoading, $ionicPopup, $ionicHistory, $state) {
    $scope.$on("$ionicView.enter", function () {
      $ionicHistory.clearCache();
      $ionicHistory.clearHistory();
  ...
  //ITV
  .controller('VeBusItvCtrl', function ($scope, $ionicActionSheet, $timeout, $rootScope,
                                        ServiciosRuat, ServicioDatos, $location, $ionicHistory, $ionicPopup, $state) {
    if ($rootScope.placa != null) {
      $scope.placaGeneral = $rootScope.placa;
    } else {
  ...
  .controller('VeDatosItvCtrl', function ($scope, $ionicActionSheet, $timeout, $rootScope,
                                          ServiciosRuat, ServicioDatos, $location, $ionicLoading, $ionicPopup, $ionicHistory, $state, $sce) {
    $scope.showLoadingProperTimes = function () {
      $ionicLoading.show({
        templateUrl: "templates/mo-spinner.html",
